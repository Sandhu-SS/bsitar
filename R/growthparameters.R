...
#'   [growthparameters_comparison()] function that not only allows
#'   estimation of adjusted parameters but also makes it possible to compare
#'   these parameters across groups.
#'
