...
test_that("bsitar works with rcs settings and sigma_formula_manual vp", {
  skip_on_cran()
  ...
  true_sbetas <- c(128.06, 0.00, 0.00, 5.01, 4.27, -12.27, -13.27, -1.40, 1.25)
  ...
  expect_equal(round(test_gparms$Estimate[2], 2), 6.40,  tolerance = 0.01)
