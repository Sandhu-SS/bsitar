...
test_that("bsitar works with rcs settings and sigma_formula_manual re", {
  skip_on_cran()
  ...
  true_sbetas <- c(128.05, 0.02, 0.01, 5.01, 4.27, -12.27, -13.27, -1.40, 1.26)
  ...
  expect_equal(round(test_gparms$Estimate[1], 2), 12.89, tolerance = 0.01)
  expect_equal(round(test_gparms$Estimate[2], 2), 6.51,  tolerance = 0.01)
