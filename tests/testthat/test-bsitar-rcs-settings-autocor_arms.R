...
test_that("bsitar works with rcs settings and autcorr arms", {
  skip_on_cran()
  ...
  true_sbetas <- c(128.05, -0.01, 0.01, 5.01, 4.28, -12.28, -13.25)
  ...
  expect_equal(round(test_gparms$Estimate[1], 2), 12.85, tolerance = 0.01)
  expect_equal(round(test_gparms$Estimate[2], 2), 6.48,  tolerance = 0.01)
