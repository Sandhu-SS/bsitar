...
test_that("bsitar works with rcs settings and sigma_formula_manual ve", {
  skip_on_cran()
  ...
  true_sbetas <- c(128.05, 0.00, 0.00, 5.01, 4.28, -12.27, -13.26, -1.69, 0.36)
  ...
  expect_equal(round(test_gparms$Estimate[2], 2), 6.45,  tolerance = 0.01)
