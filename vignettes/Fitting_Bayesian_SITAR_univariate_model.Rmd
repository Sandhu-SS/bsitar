...
achieved by: 1) shifting the high curves down and the low curves up (i.e.
adjusting for size), 2) shifting the early curves later and the late curves
earlier (timing), and 3) for intensity, the steep curves are made shallower by
stretching them along the age scale, and the shallow curves are made steeper by
shrinking them along the age scale. This explains the name SITAR - Super
Imposition by Translation And Rotation. The curve adjustment involves
translation (shifting the curves up/down and left/right) and rotation (making
them steeper or shallower), and the effect is to superimpose the curves. The
complexity of the spline curve's shape is determined by the degrees of freedom
(df) argument in the **sitar** and **bsitar** call. In our example, the models
are fit using five degrees of freedom.
