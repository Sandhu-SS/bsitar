...
in girls during puberty. The same data has been analysed in the
[vignette](https://cran.r-project.org/web/packages/sitar/vignettes/Fitting_models_with_SITAR.html)
included in the *sitar* package [@R-sitar] that implements the non-Bayesian
(frequentist) version of the SITAR model.
