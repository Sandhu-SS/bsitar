...
p + 
  geom_line(data = data_all_a %>% 
            ...
            color = colours[1], linewidth = linewidths[1], 
            alpha = alphas[1], show.legend = T) +
  geom_line(data = data_all_a %>% 
...
### Population average (mean) distance curves
```{r plotd, echo=TRUE,include=TRUE, fig.width = 6, fig.height=4, fig.asp = 1.0, fig.cap="\\label{fig:plotd}Observed and adjusted (via sitar and bsitar models) growth curves"}
...
\newline
### Population average (mean) velocity curves
...
girls experience a pubertal growth spurt but the timing of the spurt varies
between 10 and 14 years with varying growth pattern among girls. Some girls are
consistently taller than average and others consistently shorter. While some
start relatively short and become taller, others have opposite growth pattern
i.e., they are taller at an early age and acheive less height in later years as
compared to those who were short at an early age.



\newline
## Patterns of growth
The mean age at peak height velocity is 11.7 years, marked by the vertical dotted line in the plots, and the mean peak height velocity is 7.8 cm/year.



\newline
## Growth parameters (timing and intensity) for the *sitar* and *bsitar* models
...
\newline
# Correlations of random effects estimates for the *sitar* and *bsitar* models
```{r}
...
\newline
# Random effects for the first ten girls. The intensity c, multiplied by 100, is a percentage.
```{r}
