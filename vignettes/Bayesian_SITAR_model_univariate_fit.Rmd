...
output:
  rmarkdown::html_vignette:
    toc: yes
vignette: >
 %\VignetteIndexEntry{Bayesian SITAR model - Univariate fit}
...
such as ggplot2 and kableExtra)
...
Print summary for the **sitar** model
```{r summary_sitar, echo=TRUE,include=TRUE}
print(model_frequ)
```

Print summary for the **bsitar** model
```{r summary_bsitar, echo=TRUE,include=TRUE}
print(model_bayes)
```
