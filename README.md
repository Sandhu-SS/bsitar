...
- [Advanced multilevel modeling with
  ...
  (The R Journal)
- [Website](https://paul-buerkner.github.io/brms/) (Website of brms with
...
#> sd(Intercept)     0.59      0.07     0.48     0.76 1.02      102      136
#> 
#> Population-Level Effects: 
#>            Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> Intercept      1.77      0.12     1.51     1.97 1.05       80       83
#> zAge           0.09      0.09    -0.08     0.25 1.02       76      112
#> zBase          0.71      0.12     0.47     0.95 1.04       97      104
#> Trt1          -0.26      0.16    -0.55     0.07 1.03       93       90
#> zBase:Trt1     0.06      0.17    -0.28     0.39 1.03      113      155
#> 
...
#> [1,]    6.225  2.657005    2 11.025
#> [2,]    4.765  2.112365    1  9.000
```
...
#>      Estimate Est.Error     Q2.5    Q97.5
#> [1,] 5.889127 0.7177414 4.530671 7.192633
#> [2,] 4.530402 0.4574528 3.739451 5.363047
```
...
#> 
#> Computed from 200 by 236 log-likelihood matrix
#> 
#>          Estimate   SE
#> elpd_loo   -662.3 34.9
#> p_loo        84.1 12.2
...
#>                          Count Pct.    Min. n_eff
#> (-Inf, 0.5]   (good)     184   78.0%   32        
#>  (0.5, 0.7]   (ok)        41   17.4%   18        
#>    (0.7, 1]   (bad)       10    4.2%   6         
#>    (1, Inf)   (very bad)   1    0.4%   1         
...
#> Pareto k diagnostic values:
#>                          Count Pct.    Min. n_eff
#> (-Inf, 0.5]   (good)      78   33.1%   590       
#>  (0.5, 0.7]   (ok)       103   43.6%   112       
#>    (0.7, 1]   (bad)       51   21.6%   36        
#>    (1, Inf)   (very bad)   4    1.7%   4         
#> See help('pareto-k-diagnostic') for details.
#> 
#> Model comparisons:
#>      elpd_diff se_diff
