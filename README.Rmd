...
the **Stan** program to performing full Bayesian inference for a range of
regression specifications including hierarchical multivariate modeling.
...
The **bsitar** internally depends on the **brms** package which can be installed 
from the CRAN as 
